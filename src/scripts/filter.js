...
export default async function openListSort(e) {
  ...
  return axios.get(`${BASE_URL}/discover/movie?api_key=${API_KEY}&language=en-US${sortUrl}&include_adult=false&include_video=false&page=1${yearUrl}${genreUrl}&with_watch_monetization_types=flatrate`)
}
}
